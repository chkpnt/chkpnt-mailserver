...
def test_exact_match(sut, file_with_actual_content):
    excepted_content = u"""\
Date: Wed, 24 Apr 2019 00:01:35 +0200
From: vagrant@client.localdomain
To: test@mail-sink.theirdomain.test
...
def test_does_not_match(sut, file_with_actual_content):
    excepted_content = u"""\
...
def test_match_regex(sut, file_with_actual_content):
    excepted_content = u"""\
...
def test_regex_does_not_match(sut, file_with_actual_content):
    excepted_content = u"""\
...
def test_multiple_regex_in_one_line(sut, file_with_only_date_header):
    excepted_content = u"""\
...
def test_regex_needs_an_end_delimiter_to_be_recognized_as_such(sut, file_with_only_date_header):
    excepted_content = u"""\
...
def test_other_delimiters(sut, file_with_only_date_header):
...
def test_skip_lines_match1(sut, file_with_actual_content):
    excepted_content = u"""\
...
To: test@mail-sink.theirdomain.test
Subject: Test
...
def test_skip_lines_match2(sut, file_with_actual_content):
    excepted_content = u"""\
...
To: test@mail-sink.theirdomain.test
Subject: Test
...
def test_skip_lines_match3(sut, file_with_actual_content):
    excepted_content = u"""\
...
To: test@mail-sink.theirdomain.test
Subject: Test
...
def test_skip_lines_match4(sut, file_with_actual_content):
    excepted_content = u"""\
...
To: $$ .+@.+ $$
Subject: Test
...
def test_skip_lines_no_match1(sut, file_with_actual_content):
    excepted_content = u"""\
...
To: test@mail-sink.theirdomain.test
...
def test_skip_lines_no_match2(sut, file_with_actual_content):
    excepted_content = u"""\
...
To: test@mail-sink.theirdomain.test
Subject: Does not match
...
def test_skip_lines_no_match3(sut, file_with_actual_content):
    excepted_content = u"""\
...
To: test@mail-sink.theirdomain.test
Subject: Test
