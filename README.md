...
[![GitHub Workflow Status](https://img.shields.io/github/workflow/status/chkpnt/chkpnt-mailserver/run-tests?label=Tests%20against%20latest%20openSUSE%20Leap%2015.2)](https://github.com/chkpnt/chkpnt-mailserver/actions/workflows/run-tests.yml)
